...
class Log:
    ...
    def __init__(self, debugDir: str = "", debug: bool = False, initialize=True):
        ...
        Args:
            ...
            initialize (bool, optional): indicates if the logger should be initialized. Defaults to True
